...
@class NSTextView;
SWIFT_CLASS("_TtC3WTF24MainWorkspaceEditSession")
@interface MainWorkspaceEditSession : NSObject <NSTextViewDelegate>
...
@class NSCoder;
SWIFT_CLASS("_TtC3WTF24MainWorkspaceSurfaceView")
@interface MainWorkspaceSurfaceView : NSView
