...
extension ScenarioWriterView {
    ...
    func normalizeInactiveFocusModeTextEditorOffsets(
    ...
    ) -> (scanned: Int, reset: Int, skippedActive: Int) {
        guard showFocusMode else { return (0, 0, 0) }
        guard let root = NSApp.keyWindow?.contentView else { return (0, 0, 0) }
        ...
        return (scanned, resetCount, skippedActive)
    }
